# Generated by Django 3.2 on 2023-11-05 23:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, max_length=150, unique=True, validators=[django.core.validators.RegexValidator(code='invalid username', message='Имя пользователя содержит недопустимые символы.', regex='^[\\w.@+-]+\\Z'), django.core.validators.RegexValidator(code='invalid username', inverse_match=True, message='Нельзя использовать имя пользователя "me"', regex='^me$')])),
